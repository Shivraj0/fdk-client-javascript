...
declare class Inventory {
     ...
     */
    getJobCodeMetrics({ code, pageNo, pageSize, date }?: {
        code: string;
        pageNo?: number;
        pageSize?: number;
        date?: string;
