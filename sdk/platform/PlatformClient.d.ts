 ...
 */
/**
 * @typedef ApplicationProductListingResponseDatabasePowered
 * @property {Page} page
 * @property {ProductListingDetail[]} [items]
 */
/**
...
type ApplicationProductListingResponseDatabasePowered = {
    page: Page;
    items?: ProductListingDetail[];
};
